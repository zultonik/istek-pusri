...
class rbiutilitas4hecontroller extends Controller
{
    public function create()
    {
        return view('rbiutilitas4.createhe');
    }

    public function store(Request $request)
    {
    $rbiutilitas4he = rbiutilitas4he::create([
    ...
    {
    	$rbiutilitas4he = \App\rbiutilitas4he::find($id);
    	return view('rbiutilitas4.edithe',['rbiutilitas4he'=>$rbiutilitas4he]);
    }

    public function update(Request $request,$id)
    {
    	$rbiutilitas4he = \App\rbiutilitas4he::find($id);
    	$rbiutilitas4he->update($request->all());
    ...
    {
        $rbiutilitas4he = \App\rbiutilitas4he::find($id);
        return view('heutilitas4.detailhe',['rbiutilitas4he'=>$rbiutilitas4he]);
    }
}
