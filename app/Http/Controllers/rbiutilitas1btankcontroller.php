...
class rbiutilitas1btankcontroller extends Controller
{
    public function create()
    {
        return view('rbiutilitas1b.createtank');
    }

    public function store(Request $request)
    {
    $rbiutilitas1btank = rbiutilitas1btank::create([
    ...
    {
    	$rbiutilitas1btank = \App\rbiutilitas1btank::find($id);
    	return view('rbiutilitas1b.edittank',['rbiutilitas1btank'=>$rbiutilitas1btank]);
    }

    public function update(Request $request,$id)
    {
    	$rbiutilitas1btank = \App\rbiutilitas1btank::find($id);
    	$rbiutilitas1btank->update($request->all());
    ...
    {
        $rbiutilitas1btank = \App\rbiutilitas1btank::find($id);
        return view('tankutilitas1b.detailtank',['rbiutilitas1btank'=>$rbiutilitas1btank]);
    }
}
