					...
					<div class="col-md-12">
						...
						<div class="panel">
							...
							<div class="panel-body">
								<a href="{{ route('rbiurea1b.create') }}" class="btn btn-md btn-primary" style="margin-bottom: 10px"><i class="fa fa-plus"></i> <small>Add PRD</small>
								</a>
								<a href="{{ route('rbiurea1bpv.create') }}" class="btn btn-md btn-primary" style="margin-bottom: 10px"><i class="fa fa-plus"></i>
								<small>Add PV & Piping</small>
								</a>
								<a href="{{ route('rbiurea1btank.create') }}" class="btn btn-md btn-primary" style="margin-bottom: 10px"><i class="fa fa-plus"></i>
								<small>Add AST</small>
								</a>
								<a href="{{ route('rbiurea1bhe.create') }}" class="btn btn-md btn-primary" style="margin-bottom: 10px"><i class="fa fa-plus"></i>
								<small>Add HE</small>
								</a>
							</div>
						</div>
...
@section('footer')
	...
	<script type="text/javascript">
		Highcharts.chart('bar', {
		    ...
		    subtitle: {
		        text: '<a href="/prd_urea1b">Fail to Open</a>'
		    },
		    xAxis: {
	...
	<script type="text/javascript">
		Highcharts.chart('bar2', {
		    ...
		    subtitle: {
		        text: '<a href="/prd_urea1b">Leaking Final</a>'
		    },
		    xAxis: {
		        categories: ['High', 'Medium High', 'Medium', 'Low'],
		        title: {
	...
	<script type="text/javascript">
		Highcharts.chart('bar3', {
		    ...
		    subtitle: {
		        text: '<a href="/pv_urea1b">Risk Ranking Area</a>'
		    },
		    xAxis: {
		        categories: ['High', 'Medium High', 'Medium', 'Low'],
		        title: {
	...
	<script type="text/javascript">
		Highcharts.chart('bar4', {
		    ...
		    subtitle: {
		        text: '<a href="/pv_urea1b">Risk Ranking Financial</a>'
		    },
		    xAxis: {
		        categories: ['High', 'Medium High', 'Medium', 'Low'],
		        title: {
	...
	<script type="text/javascript">
		Highcharts.chart('bar5', {
		    ...
		    subtitle: {
		        text: '<a href="/ast_urea1b">Risk Ranking Area</a>'
		    },
		    xAxis: {
		        categories: ['High', 'Medium High', 'Medium', 'Low'],
		        title: {
	...
	<script type="text/javascript">
		Highcharts.chart('bar6', {
		    ...
		    subtitle: {
		        text: '<a href="/ast_urea1b">Risk Ranking Financial</a>'
		    },
		    xAxis: {
		        categories: ['High', 'Medium High', 'Medium', 'Low'],
		        title: {
	...
	<script type="text/javascript">
		Highcharts.chart('bar7', {
		    ...
		    subtitle: {
		        text: '<a href="/he_urea1b">Risk Ranking</a>'
		    },
		    xAxis: {
		        categories: ['High', 'Medium High', 'Medium', 'Low'],
		        title: {
