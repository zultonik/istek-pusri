...
class rbiurea3tankcontroller extends Controller
{
    public function create()
    {
        return view('rbiurea3.createtank');
    }

    public function store(Request $request)
    {
    $rbiurea3tank = rbiurea3tank::create([
    ...
    {
    	$rbiurea3tank = \App\rbiurea3tank::find($id);
    	return view('rbiurea3.edittank',['rbiurea3tank'=>$rbiurea3tank]);
    }

    public function update(Request $request,$id)
    {
    	$rbiurea3tank = \App\rbiurea3tank::find($id);
    	$rbiurea3tank->update($request->all());
    ...
    {
        $rbiurea3tank = \App\rbiurea3tank::find($id);
        return view('tankurea3.detailtank',['rbiurea3tank'=>$rbiurea3tank]);
    }
}
