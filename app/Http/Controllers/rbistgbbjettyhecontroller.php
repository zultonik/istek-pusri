...
class rbistgbbjettyhecontroller extends Controller
{
    public function create()
    {
        return view('rbistgbbjetty.createhe');
    }

    public function store(Request $request)
    {
    $rbistgbbjettyhe = rbistgbbjettyhe::create([
    ...
    {
    	$rbistgbbjettyhe = \App\rbistgbbjettyhe::find($id);
    	return view('rbistgbbjetty.edithe',['rbistgbbjettyhe'=>$rbistgbbjettyhe]);
    }

    public function update(Request $request,$id)
    {
    	$rbistgbbjettyhe = \App\rbistgbbjettyhe::find($id);
    	$rbistgbbjettyhe->update($request->all());
    ...
    {
        $rbistgbbjettyhe = \App\rbistgbbjettyhe::find($id);
        return view('hestgbbjetty.detailhe',['rbistgbbjettyhe'=>$rbistgbbjettyhe]);
    }
}
