			        ...
			        <div class="col-md-12">
			            <div class="panel">
			                ...
			                <div class="panel-body">
			                    <form class="form-horizontal form-label-left input_mask col-md-6 col-sm-3 col-xs-12" action="{{ route('skeluar.store') }}" method="POST" enctype="multipart/form-data">
			                        {{csrf_field()}}
								  ...
								  <div class="form-group">
								    ...
								    <div class="col-md-8 col-sm-6 col-xs-12">
								    <input name="tujuan_surat" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Tujuan Surat">
									</div>
								  </div>
								  <div class="form-group">
								    <label for="exampleInputEmail1">Tembusan Surat</label>
								    <div class="col-md-8 col-sm-6 col-xs-12">
								    <input name="tembusan_surat" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"placeholder="Tembusan Surat">
									</div>
								  </div>
								  <div class="form-group">
								  ...
								  <div class="form-group">
								    ...
								    <div class="col-md-8 col-sm-6 col-xs-12">
								    <input name="tanggal_keluar" type="date" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
									</div>
								  </div>
								  <div class="form-group">
								  ...
								  <div class="form-group">
								    ...
								    <div class="col-md-8 col-sm-6 col-xs-12">
								    <input name="penyelesaian_disposisi" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Penyelesaian Disposisi">
									</div>
								  </div>
								  <div class="form-group">
