...
class rbiammonia4hecontroller extends Controller
{
    public function create()
    {
        return view('rbiammonia4.createhe');
    }

    public function store(Request $request)
    {
    $rbiammonia4he = rbiammonia4he::create([
    ...
    {
    	$rbiammonia4he = \App\rbiammonia4he::find($id);
    	return view('rbiammonia4.edithe',['rbiammonia4he'=>$rbiammonia4he]);
    }

    public function update(Request $request,$id)
    {
    	$rbiammonia4he = \App\rbiammonia4he::find($id);
    	$rbiammonia4he->update($request->all());
    ...
    {
        $rbiammonia4he = \App\rbiammonia4he::find($id);
        return view('heammonia4.detailhe',['rbiammonia4he'=>$rbiammonia4he]);
    }
}
