...
class rbistgbbjettypvcontroller extends Controller
{
    public function create()
    {
        return view('rbistgbbjetty.createpv');
    }

    public function store(Request $request)
    {
    $rbistgbbjettypv = rbistgbbjettypv::create([
    ...
    {
    	$rbistgbbjettypv = \App\rbistgbbjettypv::find($id);
    	return view('rbistgbbjetty.editpv',['rbistgbbjettypv'=>$rbistgbbjettypv]);
    }

    public function update(Request $request,$id)
    {
    	$rbistgbbjettypv = \App\rbistgbbjettypv::find($id);
    	$rbistgbbjettypv->update($request->all());
    ...
    {
        $rbistgbbjettypv = \App\rbistgbbjettypv::find($id);
        return view('pvstgbbjetty.detailpv',['rbistgbbjettypv'=>$rbistgbbjettypv]);
    }
}
