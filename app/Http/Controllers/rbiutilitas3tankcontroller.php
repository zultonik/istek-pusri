...
class rbiutilitas3tankcontroller extends Controller
{
    public function create()
    {
        return view('rbiutilitas3.createtank');
    }

    public function store(Request $request)
    {
    $rbiutilitas3tank = rbiutilitas3tank::create([
    ...
    {
    	$rbiutilitas3tank = \App\rbiutilitas3tank::find($id);
    	return view('rbiutilitas3.edittank',['rbiutilitas3tank'=>$rbiutilitas3tank]);
    }

    public function update(Request $request,$id)
    {
    	$rbiutilitas3tank = \App\rbiutilitas3tank::find($id);
    	$rbiutilitas3tank->update($request->all());
    ...
    {
        $rbiutilitas3tank = \App\rbiutilitas3tank::find($id);
        return view('tankutilitas3.detailtank',['rbiutilitas3tank'=>$rbiutilitas3tank]);
    }
}
