...
class rbiammonia3pvcontroller extends Controller
{
    public function create()
    {
        return view('rbiammonia3.createpv');
    }

    public function store(Request $request)
    {
    $rbiammonia3pv = rbiammonia3pv::create([
    ...
    {
    	$rbiammonia3pv = \App\rbiammonia3pv::find($id);
    	return view('rbiammonia3.editpv',['rbiammonia3pv'=>$rbiammonia3pv]);
    }

    public function update(Request $request,$id)
    {
    	$rbiammonia3pv = \App\rbiammonia3pv::find($id);
    	$rbiammonia3pv->update($request->all());
    ...
    {
        $rbiammonia3pv = \App\rbiammonia3pv::find($id);
        return view('pvammonia3.detailpv',['rbiammonia3pv'=>$rbiammonia3pv]);
    }
}
