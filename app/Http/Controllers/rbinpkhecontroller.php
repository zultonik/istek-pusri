...
class rbinpkhecontroller extends Controller
{
    public function create()
    {
        return view('rbinpk.createhe');
    }

    public function store(Request $request)
    {
    $rbinpkhe = rbinpkhe::create([
    ...
    {
    	$rbinpkhe = \App\rbinpkhe::find($id);
    	return view('rbinpk.edithe',['rbinpkhe'=>$rbinpkhe]);
    }

    public function update(Request $request,$id)
    {
    	$rbinpkhe = \App\rbinpkhe::find($id);
    	$rbinpkhe->update($request->all());
    ...
    {
        $rbinpkhe = \App\rbinpkhe::find($id);
        return view('henpk.detailhe',['rbinpkhe'=>$rbinpkhe]);
    }
}
