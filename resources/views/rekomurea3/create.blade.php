			        ...
			        <div class="col-md-12">
			            <div class="panel">
			                ...
			                <div class="panel-body">
			                    <form class="form-horizontal form-label-left input_mask col-md-6 col-sm-3 col-xs-12" action="{{ route('rekomurea3.store') }}" method="POST" enctype="multipart/form-data">
			                        {{csrf_field()}}
